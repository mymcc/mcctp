...
void Application::Init() {
  ...
  m_hWC = {sizeof(m_hWC), CS_OWNDC, WndProc,       0L,  0L, GetModuleHandle(NULL), NULL, NULL,
           NULL,          NULL,     title.c_str(), NULL};
  ::RegisterClassExW(&m_hWC);
  m_hHWND = ::CreateWindowW(m_hWC.lpszClassName, title.c_str(), WS_OVERLAPPEDWINDOW, 100, 100, 1280,
                            800, NULL, NULL, m_hWC.hInstance, NULL);
